...
def main():
    ...
    cifar_traindata = cifar_traindata[:2]
    for digit in cifar_traindata:
        split_cifar_traindata.append(data_split(digit, 200))
    ...
    cifar_testdata = cifar_testdata[:2]
    for digit in cifar_testdata:
        split_cifar_testdata.append(data_split(digit, 200))
