...
plot_learning('result_output_differ/fedavg9/width_128_diff_client_0_nonlinear_linearlinear_regressionmnist_all_data_1_linear_regression_niid.npy',
              ax, label='output_diff_width128', linestyle='-', color='tab:blue')
plot_learning('result_output_differ/fedavg9/width_4096_diff_client_0_nonlinear_linearlinear_regressionmnist_all_data_1_linear_regression_niid.npy',
              ax, label='output_diff_width4096', linestyle='-', color='tab:red')
...
ax.set_ylabel(r'$\sqrt{||f_i^{\rm lin} - f_i||^2_2/|\mathcal{D}_i|}$')
ax.grid()
